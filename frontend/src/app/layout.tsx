...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="bg-slate-950">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen bg-[#030712] text-sky-100 selection:bg-sky-500/40 selection:text-sky-50`}
      >
        <div className="relative isolate min-h-screen overflow-hidden">
          <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.18),_transparent_55%),radial-gradient(circle_at_bottom,_rgba(14,165,233,0.12),_transparent_60%)]" />
          ...
          <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 pb-12 pt-6 sm:px-8">
            ...
            <footer className="mt-auto flex flex-col gap-3 border-t border-slate-800/70 py-6 text-[13px] text-sky-100/60 sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="flex items-center gap-3 text-sky-100/50">
                <span className="h-2 w-2 animate-pulse rounded-full bg-sky-500 shadow-[0_0_20px_rgba(56,189,248,0.6)]" />
